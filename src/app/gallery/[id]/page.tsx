        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Creator asdf  asdf asd</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 sticky top-24">
          <Card className="overflow-hidden border-0 shadow-lg rounded-xl p-0">
            <div className="bg-linear-to-r from-gray-900 to-gray-800 p-6 text-white">
              <h3 className="text-xl font-bold mb-2">Premium Asset fg</h3>
              <div>
                ...
                {session?.user ? (
                  isAuthor ? (
                    <div className="bg-blue-50 text-blue-700 p-5 rounded-lg flex items-start gap-3">
                      ...
                      <p>This is your own asset. You cannot purchase your own asset.</p>
                    </div>
                  ) : (
